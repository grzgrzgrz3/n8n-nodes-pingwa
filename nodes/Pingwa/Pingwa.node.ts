  ...
  description: INodeTypeDescription = {
    ...
    properties: [
        ...
        options: [
          {
            ...
            description: 'Send a message and do not wait for a reply',
          },
          {
            name: 'Ask',
            value: 'ask',
            action: 'Ask a question and wait for a reply',
            description: 'Send a question and wait until you answer, or until it times out',
          },
          {
            name: 'Get Reply',
            value: 'getReply',
            action: 'Get the reply to a message',
            description: 'Fetch the reply to a message you sent earlier',
          },
        ],
        default: 'notify',
      },
      ...
      },
      {
        ...
        description: 'Optional reply buttons. If the chat window is closed, they appear as a numbered list in the text.',
        displayOptions: { show: { operation: ['ask'] } },
      },
      {
        ...
        description: 'How long to wait for a reply. 0 uses the server default. The server limits this to its maximum.',
        displayOptions: { show: { operation: ['ask'] } },
      },
      {
      ...
      },
      {
        ...
        type: 'number',
        default: 0,
        description: 'Wait up to this many seconds for a reply. 0 returns immediately.',
        displayOptions: { show: { operation: ['getReply'] } },
      },
    ],
  };
